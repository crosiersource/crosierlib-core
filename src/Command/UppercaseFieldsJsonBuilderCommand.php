...
namespace CrosierSource\CrosierLibCoreBundle\Command;
    ...
    public function buildJson(OutputInterface $output)
    {
        ...
        foreach ($all as $classMeta) {
            ...
            foreach ($eMeta->getFieldNames() as $field) {
                $notUppercaseAnnotation = $annotationReader->getPropertyAnnotation(new \ReflectionProperty($classMeta->getName(), $field), 'CrosierSource\CrosierLibCoreBundle\Doctrine\Annotations\NotUppercase');
