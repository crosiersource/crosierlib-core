...
class EntMenuRepository extends FilterRepository
{
    ...
    {
        $dql = "SELECT e FROM CrosierSource\CrosierLibCoreBundle\Entity\Config\EntMenu e WHERE e.paiUUID IS NULL OR e.tipo = :tipo ORDER BY e.label";
    ...
    {
        $ql = "SELECT e FROM CrosierSource\CrosierLibCoreBundle\Entity\Config\EntMenu e WHERE e.paiUUID = :entMenuPaiUUID ORDER BY e.ordem";
