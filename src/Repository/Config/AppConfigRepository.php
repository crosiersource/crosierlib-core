...
class AppConfigRepository extends FilterRepository
{
    ...
    {
        try {
            $dql = "SELECT c FROM CrosierSource\CrosierLibCoreBundle\Entity\Config\AppConfig c WHERE c.appUUID = :appUUID AND c.chave = :chave";
    ...
    {
        try {
            $dql = 'SELECT ac FROM CrosierSource\CrosierLibCoreBundle\Entity\Config\AppConfig ac JOIN CrosierSource\CrosierLibCoreBundle\Entity\Config\App app WITH ac.appUUID = app.UUID WHERE app.nome = :appNome AND ac.chave = :chave';
            $qry = $this->getEntityManager()->createQuery($dql);
    ...
    {
        try {
            $dql = 'SELECT ac FROM CrosierSource\CrosierLibCoreBundle\Entity\Config\AppConfig ac WHERE ac.chave = :chave AND ac.appUUID = :appUUID';
            $qry = $this->getEntityManager()->createQuery($dql);
            $qry->setParameter('chave', $chave);
